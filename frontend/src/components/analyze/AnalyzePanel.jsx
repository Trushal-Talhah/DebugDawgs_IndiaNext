...
import { Mail, ScanSearch, ChevronDown, Image, Film } from 'lucide-react';
...
function AnalyzePanel({ onAnalyze, onAnalyzeImage, onAnalyzeVideo, isLoading = false, prefillValue = '' }) {
  ...
  const isMediaMode = ['image'].includes(type);
